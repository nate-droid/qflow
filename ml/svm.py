...
# between each point in the mesh and ALL the training points.
print("Computing the decision boundary...")
mesh_data = np.c_[xx.ravel(), yy.ravel()]
# CORRECTED LINE: Compute kernel against the full X_train, not just support vectors.
gram_test = compute_gram_matrix(mesh_data, X_train)
...
# We can still highlight the support vectors on the plot
